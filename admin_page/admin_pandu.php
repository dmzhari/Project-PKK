    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 p-3 px-md-4 mr-auto offset-md-3">
                <div class="card">
                    <h4 class="text-center card-header">Form Edit Panduan Daftar</h4>
                    <div class="card-body">
                        <div class="form-group pt-3">
                            <div class="input-group is-invalid">
                                ...
                                <input type="text" name="judul" id="judul" class="bg-transparent form-control" placeholder="Masukan Judul" value="<?= $query[0]['jdpandu'] ?>" required>
                            </div>
                            <textarea class="form-control"><?= $query[0]['pandudaftar'] ?></textarea>
                        </div>
